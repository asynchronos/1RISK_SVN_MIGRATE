<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="UserManage.aspx.cs" Inherits="LGDCollectionData.Account.UserManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource1" EnableModelValidation="True"
        ...
        <EditItemTemplate>
            EMP_ID:
            <asp:Label ID="EMP_IDLabel1" runat="server" Text='<%# Bind("EMP_ID") %>' />
            <br />
            EMP_ID_DISPLAY:
            <asp:TextBox ID="EMP_ID_DISPLAYTextBox" runat="server" Text='<%# Bind("EMP_ID_DISPLAY") %>' />
            <br />
            EMP_TITLE:
            ...
            <br />
            PHONE_OFFICE:
            <asp:TextBox ID="PHONE_OFFICETextBox" runat="server" Text='<%# Bind("PHONE_OFFICE") %>' />
            <br />
            PHONE_HOME:
            <asp:TextBox ID="PHONE_HOMETextBox" runat="server" Text='<%# Bind("PHONE_HOME") %>' />
            <br />
            PHONE_MOBILE:
            <asp:TextBox ID="PHONE_MOBILETextBox" runat="server" Text='<%# Bind("PHONE_MOBILE") %>' />
            <br />
            CREATE_DATE:
            ...
            <br />
            LAST_SIGN_ON_DATE:
            <asp:TextBox ID="LAST_SIGN_ON_DATETextBox" runat="server" Text='<%# Bind("LAST_SIGN_ON_DATE") %>' />
            <br />
            LAST_CHANGE_PASS_DATE:
            <asp:TextBox ID="LAST_CHANGE_PASS_DATETextBox" runat="server" Text='<%# Bind("LAST_CHANGE_PASS_DATE") %>' />
            <br />
            DEL_FLAG:
        ...
        <ItemTemplate>
            ...
            <br />
            EMP_ID_DISPLAY:
            <asp:Label ID="EMP_ID_DISPLAYLabel" runat="server" Text='<%# Bind("EMP_ID_DISPLAY") %>' />
            <br />
            EMP_TITLE:
            ...
            <br />
            EMP_SURNAME:
            <asp:Label ID="EMP_SURNAMELabel" runat="server" Text='<%# Bind("EMP_SURNAME") %>' />
            <br />
            EMP_TITLE_E:
            <asp:Label ID="EMP_TITLE_ELabel" runat="server" Text='<%# Bind("EMP_TITLE_E") %>' />
            <br />
            EMP_NAME_E:
            <asp:Label ID="EMP_NAME_ELabel" runat="server" Text='<%# Bind("EMP_NAME_E") %>' />
            <br />
            EMP_SURNAME_E:
            <asp:Label ID="EMP_SURNAME_ELabel" runat="server" Text='<%# Bind("EMP_SURNAME_E") %>' />
            <br />
            PASSWD:
            ...
            <br />
            PHONE_OFFICE:
            <asp:Label ID="PHONE_OFFICELabel" runat="server" Text='<%# Bind("PHONE_OFFICE") %>' />
            <br />
            PHONE_HOME:
            <asp:Label ID="PHONE_HOMELabel" runat="server" Text='<%# Bind("PHONE_HOME") %>' />
            <br />
            PHONE_MOBILE:
            <asp:Label ID="PHONE_MOBILELabel" runat="server" Text='<%# Bind("PHONE_MOBILE") %>' />
            <br />
            CREATE_DATE:
            ...
            <br />
            LAST_SIGN_ON_DATE:
            <asp:Label ID="LAST_SIGN_ON_DATELabel" runat="server" Text='<%# Bind("LAST_SIGN_ON_DATE") %>' />
            <br />
            LAST_CHANGE_PASS_DATE:
            <asp:Label ID="LAST_CHANGE_PASS_DATELabel" runat="server" Text='<%# Bind("LAST_CHANGE_PASS_DATE") %>' />
            <br />
            DEL_FLAG:
            <asp:CheckBox ID="DEL_FLAGCheckBox" runat="server" Checked='<%# Bind("DEL_FLAG") %>'
                Enabled="false" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LGDConnectionString1 %>"
        DeleteCommand="DELETE FROM [USER_DATA] WHERE [EMP_ID] = @EMP_ID" InsertCommand="INSERT INTO [USER_DATA] ([EMP_ID], [EMP_ID_DISPLAY], [EMP_TITLE], [EMP_NAME], [EMP_SURNAME], [EMP_TITLE_E], [EMP_NAME_E], [EMP_SURNAME_E], [PASSWD], [EMAIL], [PHONE_OFFICE], [PHONE_HOME], [PHONE_MOBILE], [CREATE_DATE], [EXPIRE_DATE], [UPDATE_DATE], [LAST_SIGN_ON_DATE], [LAST_CHANGE_PASS_DATE], [DEL_FLAG]) VALUES (@EMP_ID, @EMP_ID_DISPLAY, @EMP_TITLE, @EMP_NAME, @EMP_SURNAME, @EMP_TITLE_E, @EMP_NAME_E, @EMP_SURNAME_E, @PASSWD, @EMAIL, @PHONE_OFFICE, @PHONE_HOME, @PHONE_MOBILE, @CREATE_DATE, @EXPIRE_DATE, @UPDATE_DATE, @LAST_SIGN_ON_DATE, @LAST_CHANGE_PASS_DATE, @DEL_FLAG)"
