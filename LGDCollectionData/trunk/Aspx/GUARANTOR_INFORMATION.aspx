<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GUARANTOR_INFORMATION.aspx.cs" Inherits="LGDCollectionData.Aspx.GUARANTOR_INFORMATION"
        ...
        <tr>
            <td>
                ...
                <asp:DetailsView ID="DetailsView2" runat="server" AllowPaging="True" AutoGenerateRows="False"
                    DataSourceID="SqlDataSourceGur_Info" EnableModelValidation="True" DefaultMode="Edit"
                    CellPadding="4" ForeColor="#333333" GridLines="Both" OnPageIndexChanging="DetailsView_PageIndexChanging"
                    OnItemUpdating="DetailsView_ItemUpdating" OnItemUpdated="DetailsView_ItemUpdated"
                    OnPreRender="DetailsView2_OnPreRender" DataKeyNames="CIF,Default_Date,PLED_ID">
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="Guarantee Title" SortExpression="Guarantee_Title">
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Facility Pledged" SortExpression="Facility_Pledged">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBoxFacility_Pledged" runat="server" Text='<%# Bind("Facility_Pledged") %>'
                                    domId="TextBoxFacility_Pledged"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Guarantee Amount @ D" SortExpression="Guarantee_Amount_D">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("Guarantee_Amount_D","{0:#,##0.00}") %>'
                            ...
                            <InsertItemTemplate>
                                <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("Guarantee_Amount_D","{0:#,##0.00}") %>'
                                    IsNumeric="Yes" Style="text-align: right;">
                                </asp:TextBox>
                                <span style="color: Red">*</span>
                            </InsertItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Guarantee Amount @ D-1" SortExpression="Guarantee_Amount_D1">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("Guarantee_Amount_D1","{0:#,##0.00}") %>'
                                    IsNumeric="Yes" Style="text-align: right;"></asp:TextBox>
                            ...
                            <InsertItemTemplate>
                                <asp:TextBox ID="TextBoxGuarantee_Amount_D1_Insert" runat="server" Text='<%# Bind("Guarantee_Amount_D1","{0:#,##0.00}") %>'
                                    IsNumeric="Yes" Style="text-align: right;">
                                </asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Guarantee Amount Currency Code" SortExpression="Guarantee_Amount_Currency_Code">
                            <EditItemTemplate>
                                <%--<asp:TextBox ID="TextBox4" runat="server"
                                Text='<%# Bind("Guarantee_Amount_Currency_Code") %>'></asp:TextBox>--%>
                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSourceCurrentcy"
                                    DataTextField="Description" DataValueField="Code" SelectedValue='<%# Bind("Guarantee_Amount_Currency_Code")%>'>
                                </asp:DropDownList>
                                <span style="color: Red">*</span>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:DropDownList ID="DropDownList1_Insert" runat="server" DataSourceID="SqlDataSourceCurrentcy"
                                    DataTextField="Description" DataValueField="Code" SelectedValue='<%# Bind("Guarantee_Amount_Currency_Code")%>'>
                                </asp:DropDownList>
                                <span style="color: Red">*</span>
                            </InsertItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("Guarantee_Amount_Currency_Code") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Guarantee Indemnity Source ID" SortExpression="Guarantee_Indemnity_Source_ID">
                            <EditItemTemplate>
                                ...
                                <asp:ComboBox ID="Guarantee_Indemnity_Source_ID_for_ComboBox" runat="server" AppendDataBoundItems="True"
                                    MaxLength="0" SelectedValue='<%# Bind("Guarantee_Indemnity_Source_ID") %>' Style="display: inline;
                                    text-align: center;" DataSourceID="SqlDataSourceGar_Ind" DataTextField="Guarantee_Indemnity_Source_ID"
                            ...
                            <InsertItemTemplate>
                                <asp:ComboBox ID="Guarantee_Indemnity_Source_ID_for_ComboBox" runat="server" AppendDataBoundItems="True"
                                    SelectedValue='<%# Bind("Guarantee_Indemnity_Source_ID") %>' DataSourceID="SqlDataSourceGar_Ind"
                                    DataTextField="Guarantee_Indemnity_Source_ID" DataValueField="Guarantee_Indemnity_Source_ID">
                                    <asp:ListItem Value="">Please Select</asp:ListItem>
                                </asp:ComboBox>
                                <span style="color: Red">*</span>
                            </InsertItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("Guarantee_Indemnity_Source_ID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Internal Rating @ D-1" SortExpression="Internal_Rating_D">
                            <EditItemTemplate>
                                <asp:TextBox ID="Internal_Rating_DTextBox" runat="server" Text='<%# Bind("Internal_Rating_D") %>'>
                                </asp:TextBox>
                            ...
                            <InsertItemTemplate>
                                <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("Internal_Rating_D") %>'></asp:TextBox>
                                <span style="color: Red">*</span>
                            </InsertItemTemplate>
                            <ItemTemplate>
                ...
                <asp:ValidationSummary ID="ValidationSummaryInsert" runat="server" ShowMessageBox="true"
                    ValidationGroup="InsertValidation" ShowSummary="False" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceGur_Info" runat="server" ConnectionString="<%$ ConnectionStrings:LGDConnectionString1 %>"
                    InsertCommand="GUARANTOR_INFORMATION_INSERT" InsertCommandType="StoredProcedure"
                    SelectCommand="GUARANTOR_INFORMATION_SELECT" SelectCommandType="StoredProcedure"
                    UpdateCommand="GUARANTOR_INFORMATION_UPDATE" UpdateCommandType="StoredProcedure"
                ...
                <asp:SqlDataSource ID="SqlDataSourceGar_Ind" runat="server" ConnectionString="<%$ ConnectionStrings:LGDConnectionString1 %>"
                    SelectCommand="GUARANTOR_INFORMATION_INDEMNITY_SELECT" SelectCommandType="StoredProcedure">
                </asp:SqlDataSource>
            </td>
        </tr>
    </table>
