...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="Financial_Summary_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:LGDConnectionString1 %>"
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="Total_Assets" Type="Double" />
            <asp:Parameter Name="Total_Liabilities" Type="Double" />
            <asp:Parameter Name="Total_Revenue" Type="Double" />
    ...
    <asp:DetailsView ID="Financial_Summary_DetailsView" runat="server" AllowPaging="True"
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Total Assets(in thousand)" SortExpression="Total_Assets">
                <EditItemTemplate>
                    <asp:TextBox ID="Total_Assets_TextBox" runat="server" Text='<%# Bind("Total_Assets","{0:#,##0.00}") %>'
                ...
                <ItemTemplate>
                    <asp:Label ID="Total_Assets_Label" runat="server" Text='<%# Bind("Total_Assets","{0:#,##0.00}") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Total Liabilities(in thousand)" SortExpression="Total_Liabilities">
                <EditItemTemplate>
                    <asp:TextBox ID="Total_Liabilities_TextBox" runat="server" Text='<%# Bind("Total_Liabilities","{0:#,##0.00}") %>'
                ...
                <ItemTemplate>
                    <asp:Label ID="Total_Liabilities_Label" runat="server" Text='<%# Bind("Total_Liabilities","{0:#,##0.00}") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Total Revenue(in thousand)" SortExpression="Total_Revenue">
                <EditItemTemplate>
                    <asp:TextBox ID="Total_Revenue_TextBox" runat="server" Text='<%# Bind("Total_Revenue","{0:#,##0.00}") %>'
                ...
                <ItemTemplate>
                    <asp:Label ID="LabelTotal_Revenue" runat="server" Text='<%# Bind("Total_Revenue","{0:#,##0.00}") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
