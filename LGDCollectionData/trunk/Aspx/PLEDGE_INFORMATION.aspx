    ...
    <asp:GridView ID="GridView_COLL_INFO" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="COLL ID" SortExpression="COLL_ID" HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                ...
                <FooterTemplate>
                    <asp:TextBox ID="LabelCOLL_ID_Footer" runat="server" Width="11ex"></asp:TextBox>
                </FooterTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="District of Property" SortExpression="District_of_Property" HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBoxDistrict_of_Property" runat="server" Text='<%# Bind("District_of_Property") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Amphur of Property" SortExpression="Amphur_of_Property" HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBoxAmphur_of_Property" runat="server" Text='<%# Bind("Amphur_of_Property") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Located Country of Property" SortExpression="Located_Country_of_Property" HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBoxLocated_Country_of_Property" runat="server" Text='<%# Bind("Located_Country_of_Property") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Leasehold Period" SortExpression="Leasehold_Period" HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBoxLeasehold_Period" runat="server" Text='<%# Bind("Leasehold_Period") %>' IsNumber="Yes"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
