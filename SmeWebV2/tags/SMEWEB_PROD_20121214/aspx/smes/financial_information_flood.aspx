<%@ Page Language="VB" AutoEventWireup="false" CodeFile="financial_information_flood.aspx.vb"
    Inherits="smes_financial_information_ss" %>
...
<body>
    ...
    <div id="header">
        <h4>
            <asp:Label ID="labelHead" runat="server" Text="Flood Program Information (ข้อมูลพื้นฐาน) "
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="BUSINESS_GROUP_IDTextBox" ToolTip="รหัสธุรกิจ" runat="server"
                    Width="100" />
                &nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="BUSINESS_GROUPTextBox" ToolTip="ธุรกิจ" runat="server"
                    Width="248px" />
            </td>
        </tr>
        <tr>
