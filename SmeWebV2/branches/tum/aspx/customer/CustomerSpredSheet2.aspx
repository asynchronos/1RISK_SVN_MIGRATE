<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CustomerSpredSheet2.aspx.vb" Inherits="aspx_customer_CustomerSpredSheet2"  MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
     <div class="fixedHeader" style="width:2100px; height:700px; overflow-y:scroll;">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="SELECT * FROM [CIF_GROUP_SHEET_100] order by CM_CODE " 
            DeleteCommand="DELETE FROM [CIF_GROUP_SHEET_100] WHERE [CIF] = @original_CIF" 
            InsertCommand="INSERT INTO [CIF_GROUP_SHEET_100] ([CIF], [CUSTOMER_NAME], [GROUP_ID], [CM_CODE], [CM_NAME], [OLD_CM_CODE], [OLD_CM_NAME], [BRANCH_ID], [BRANCH_NAME], [Id_Region], [Region_Name], [GROUP_SIZE_ID], [GROUP_SIZE_DETAIL], [A], [AP], [P], [C], [Balance_Sheet_CIF], [CIF_Balance_Sheet]) VALUES (@CIF, @CUSTOMER_NAME, @GROUP_ID, @CM_CODE, @CM_NAME, @OLD_CM_CODE, @OLD_CM_NAME, @BRANCH_ID, @BRANCH_NAME, @Id_Region, @Region_Name, @GROUP_SIZE_ID, @GROUP_SIZE_DETAIL, @A, @AP, @P, @C, @Balance_Sheet_CIF, @CIF_Balance_Sheet,@Remark,getdate())" 
            UpdateCommand="UPDATE [CIF_GROUP_SHEET_100] SET [CUSTOMER_NAME] = @CUSTOMER_NAME, [GROUP_ID] = @GROUP_ID, [CM_CODE] = @CM_CODE, [CM_NAME] = @CM_NAME, [OLD_CM_CODE] = @OLD_CM_CODE, [OLD_CM_NAME] = @OLD_CM_NAME, [BRANCH_ID] = @BRANCH_ID, [BRANCH_NAME] = @BRANCH_NAME, [Id_Region] = @Id_Region, [Region_Name] = @Region_Name, [GROUP_SIZE_ID] = @GROUP_SIZE_ID, [GROUP_SIZE_DETAIL] = @GROUP_SIZE_DETAIL, [A] = @A, [AP] = @AP, [P] = @P, [C] = @C, [Balance_Sheet_CIF] = @Balance_Sheet_CIF, [CIF_Balance_Sheet] = @CIF_Balance_Sheet ,Remark=@Remark,Update_date=getdate() WHERE [CIF] = @original_CIF" >
            <DeleteParameters>
