...
Partial Class aspx_customer_BusinessType
    ...
    Protected Sub SearchButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchButton.Click
        Response.Redirect(Page.ResolveUrl("~/aspx/customer/BusinessType.aspx?businessTypeDetail=") + keywordsTextBox.Text + "&returnIdTarget=" + Request.QueryString("returnIdTarget") + "&returnDetailTarget=" + Request.QueryString("returnDetailTarget"))
    End Sub
