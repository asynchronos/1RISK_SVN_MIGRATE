...
Partial Class smes_financial_information_ss
    ...
    Sub bindDropDown()
        ...
        dr = dt.Select("LIST_TYPE='PURPOSE'")
        ...
        dr = dt.Select("LIST_TYPE='COLLATERAL'")
        For i = 0 To dr.GetUpperBound(0)
            Dim item As New ListItem(dr(i)(2), dr(i)(1))
        ...
        dr = dt.Select("LIST_TYPE='WATCHLIST'")
        For i = 0 To dr.GetUpperBound(0)
            Dim item As New ListItem(dr(i)(2), dr(i)(1))
        ...
        dr = dt.Select("LIST_TYPE='NETPROFIT'")
        For i = 0 To dr.GetUpperBound(0)
            Dim item As New ListItem(dr(i)(2), dr(i)(1))
