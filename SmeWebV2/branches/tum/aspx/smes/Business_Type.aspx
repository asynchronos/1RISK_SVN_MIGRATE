...
<body>
    ...
    <div>
        <asp:DropDownList ID="DropDownListBusinessGroup" runat="server" DataSourceID="BusinessGroupDataSource"
            DataTextField="BUSINESS_GROUP_NAME" DataValueField="BUSINESS_GROUP_ID" AutoPostBack="True">
        </asp:DropDownList>
    ...
    <asp:SqlDataSource runat="server" ID="BusinessTypeSqldatasource" ConnectionString="<%$ ConnectionStrings:BAY01ConnectionString %>"
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownListBusinessGroup" Name="BUSINESS_GROUP_ID"
                PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:GridView ID="BusinessGridView" runat="server" EnableModelValidation="True" DataSourceID="BusinessTypeSqldatasource"
