<%@ Page Language="VB" AutoEventWireup="false" CodeFile="financial_information_ss.aspx.vb"
...
<body>
    ...
    <div id="header">
        <h4>
            <asp:Label ID="labelHead" runat="server" Text="SS Project Information (ข้อมูลพื้นฐาน)"
