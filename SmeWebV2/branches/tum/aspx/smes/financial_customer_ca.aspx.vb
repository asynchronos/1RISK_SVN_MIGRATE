        ...
        Try
            ...
            Else
                While reader.Read()
                    ...
                    If TemplateTextBox.Text <> "1" Then  ' ถ้าเป็น template อื่น ๆ ที่ไม่ใช่ ss แสดง
                    ...
                    If TemplateTextBox.Text = "1" Then  ' ถ้าเป็น template ss
...
<System.Web.Services.WebMethod()> _
    ...
    Protected Sub AddDebtButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles AddDebtButton.Click
        ...
        If UseValueDateTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("USE_VALUE_DATE", DBNull.Value)
        Else
