...
Partial Class aspx_smes_FINANCIAL_DATA
    ...
    Sub ShowData(ByVal smes_id As String, ByVal smes_type As String, ByVal action As Integer)
        ...
        Dim Sql As String = "SME_S.P_SS_FINANCIAL_DATA_INPUT_SELECT "
        ...
        If reader.HasRows Then   ' ถ้ามี row แสดงว่ามีการเพิ่มแล้ว
            ...
            While reader.Read()
                ...
                If IsDBNull(reader("CONTRACT_YEAR")) = False Then CONTRACT_YEARTextBox.Text = String.Format("{0:n2}", reader("CONTRACT_YEAR"))
                ...
                If IsDBNull(reader("CREDIT_SALE2")) = False Then CREDIT_SALE2TextBox.Text = String.Format("{0:n0}", reader("CREDIT_SALE2"))
                If IsDBNull(reader("CREDIT_TERM2")) = False Then CREDIT_TERM2TextBox.Text = String.Format("{0:n0}", reader("CREDIT_TERM2"))
                If IsDBNull(reader("PURCHASE2")) = False Then PURCHASE2TextBox.Text = String.Format("{0:n0}", reader("PURCHASE2"))
                If IsDBNull(reader("CREDIT_PURCHASE2")) = False Then CREDIT_PURCHASE2TextBox.Text = String.Format("{0:n0}", reader("CREDIT_PURCHASE2"))
                If IsDBNull(reader("TERM_PURCHASE2")) = False Then TERM_PURCHASE2TextBox.Text = String.Format("{0:n0}", reader("TERM_PURCHASE2"))
                If IsDBNull(reader("DEFAULT_MARGIN2")) = False Then DefaultMargin2TextBox.Text = String.Format("{0:n2}", reader("DEFAULT_MARGIN2"))
                If IsDBNull(reader("GROSS_PROFIT2")) = False Then GROSS_PROFIT2TextBox.Text = String.Format("{0:n0}", reader("GROSS_PROFIT2"))

                If IsDBNull(reader("SALES3")) = False Then SALES3TextBox.Text = String.Format("{0:n0}", reader("SALES3"))
                If IsDBNull(reader("CREDIT_SALE3")) = False Then CREDIT_SALE3TextBox.Text = String.Format("{0:n0}", reader("CREDIT_SALE3"))
                If IsDBNull(reader("CREDIT_TERM3")) = False Then CREDIT_TERM3TextBox.Text = String.Format("{0:n0}", reader("CREDIT_TERM3"))
                If IsDBNull(reader("PURCHASE3")) = False Then PURCHASE3TextBox.Text = String.Format("{0:n0}", reader("PURCHASE3"))
                If IsDBNull(reader("CREDIT_PURCHASE3")) = False Then CREDIT_PURCHASE3TextBox.Text = String.Format("{0:n0}", reader("CREDIT_PURCHASE3"))
                If IsDBNull(reader("TERM_PURCHASE3")) = False Then TERM_PURCHASE3TextBox.Text = String.Format("{0:n0}", reader("TERM_PURCHASE3"))
                If IsDBNull(reader("DEFAULT_MARGIN3")) = False Then DefaultMargin3TextBox.Text = String.Format("{0:n2}", reader("DEFAULT_MARGIN3"))
                If IsDBNull(reader("GROSS_PROFIT3")) = False Then GROSS_PROFIT3TextBox.Text = String.Format("{0:n0}", reader("GROSS_PROFIT3"))

                If IsDBNull(reader("CREDIT_LIMIT_BAY")) = False Then CREDIT_LIMIT_BAYTextBox.Text = String.Format("{0:n0}", reader("CREDIT_LIMIT_BAY"))
                If IsDBNull(reader("CREDIT_LIMIT_OTHER")) = False Then CREDIT_LIMIT_OTHERTextBox.Text = String.Format("{0:n0}", reader("CREDIT_LIMIT_OTHER"))
                If IsDBNull(reader("CREDIT_LIMIT_TCG")) = False Then CREDIT_LIMIT_TCGTextBox.Text = String.Format("{0:n0}", reader("CREDIT_LIMIT_TCG"))

                If IsDBNull(reader("BUSINESS_TYPE_ID_2")) = False Then BusinessTypeID2TextBox.Text = String.Format("{0:n0}", reader("BUSINESS_TYPE_ID_2"))
                If IsDBNull(reader("BUSINESS_TYPE_ID_3")) = False Then BusinessTypeID3TextBox.Text = String.Format("{0:n0}", reader("BUSINESS_TYPE_ID_3"))
                If IsDBNull(reader("BUSINESS_TYPE_2")) = False Then BusinessType2TextBox.Text = String.Format("{0:n0}", reader("BUSINESS_TYPE_2"))
                If IsDBNull(reader("BUSINESS_TYPE_3")) = False Then BusinessType3TextBox.Text = String.Format("{0:n0}", reader("BUSINESS_TYPE_3"))

                If IsDBNull(reader("LTV")) = False Then LTVTextBox.Text = String.Format("{0:n2}", reader("LTV"))
                If IsDBNull(reader("TCG_LOAN")) = False Then TCG_LOANTextBox.Text = String.Format("{0:n0}", reader("TCG_LOAN"))
                If IsDBNull(reader("TCG_INTEREST_RATE_PERCENT_USED")) = False Then TCG_INTEREST_RATE_PERCENT_USEDTextBox.Text = String.Format("{0:n2}", reader("TCG_INTEREST_RATE_PERCENT_USED"))
                If IsDBNull(reader("TCG_CONTRACT_YEAR")) = False Then TCG_CONTRACT_YEARTextBox.Text = String.Format("{0:n2}", reader("TCG_CONTRACT_YEAR"))
                If IsDBNull(reader("TCG_GUARANTEE_OLD")) = False Then TCG_GUARANTEE_OLDTextBox.Text = String.Format("{0:n0}", reader("TCG_GUARANTEE_OLD"))
                If IsDBNull(reader("STMT_TYPE")) = False Then
                    STMT_TYPEDropDownList.SelectedIndex = STMT_TYPEDropDownList.Items.IndexOf(STMT_TYPEDropDownList.Items.FindByValue(reader("STMT_TYPE")))
                End If
        ...
        While reader.Read()
            ...
            ' ลบส่วนดึงตัวแปรตามประเภทธุรกิจออกไปตาม template 3x

            If IsDBNull(reader("BUSINESS_ID")) = False Then
                BusinessTypeID1TextBox.Text = reader("BUSINESS_ID").ToString()
            Else
                BusinessTypeID1TextBox.Text = 0
            End If

            If IsDBNull(reader("BUSINESS_NAME")) = False Then
                BusinessType1TextBox.Text = reader("BUSINESS_NAME").ToString()
            Else
                BusinessType1TextBox.Text = 0
            End If
    ...
    Sub SaveData(ByVal action As String)
        ...
        If action = "Insert" Then
            sqlCmd.CommandText = "[SME_S].[P_SS_FINANCIAL_DATA_INPUT_INSERT]"
        Else
            sqlCmd.CommandText = "[SME_S].[P_SS_FINANCIAL_DATA_INPUT_UPDATE]"
        End If
        ...
        If DefaultMarginTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("DEFAULT_MARGIN", 0)

        Else
            sqlCmd.Parameters.AddWithValue("DEFAULT_MARGIN", ToDecimal(DefaultMarginTextBox.Text))
        ...
        If FEE_CREDIT_CART_REPAYMENTTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("FEE_CREDIT_CART_REPAYMENT", 0)
        Else
            sqlCmd.Parameters.AddWithValue("FEE_CREDIT_CART_REPAYMENT", ToDecimal(FEE_CREDIT_CART_REPAYMENTTextBox.Text))
        End If




        If SALES2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("SALES2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("SALES2", ToDecimal(SALES2TextBox.Text))
        End If

        If CREDIT_SALE2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_SALE2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_SALE2", ToDecimal(CREDIT_SALE2TextBox.Text))
        End If
        If CREDIT_TERM2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_TERM2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_TERM2", ToDecimal(CREDIT_TERM2TextBox.Text))
        End If
        If PURCHASE2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("PURCHASE2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("PURCHASE2", ToDecimal(PURCHASE2TextBox.Text))
        End If
        If CREDIT_PURCHASE2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_PURCHASE2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_PURCHASE2", ToDecimal(CREDIT_PURCHASE2TextBox.Text))
        End If
        If TERM_PURCHASE2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("TERM_PURCHASE2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("TERM_PURCHASE2", ToDecimal(TERM_PURCHASE2TextBox.Text))
        End If
        If DefaultMargin2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("DEFAULT_MARGIN2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("DEFAULT_MARGIN2", ToDecimal(DefaultMargin2TextBox.Text))
        End If

        If GROSS_PROFIT2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("GROSS_PROFIT2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("GROSS_PROFIT2", ToDecimal(GROSS_PROFIT2TextBox.Text))
        End If

        If SALES3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("SALES3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("SALES3", ToDecimal(SALES3TextBox.Text))
        End If

        If CREDIT_SALE3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_SALE3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_SALE3", ToDecimal(CREDIT_SALE3TextBox.Text))
        End If

        If CREDIT_TERM3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_TERM3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_TERM3", ToDecimal(CREDIT_TERM3TextBox.Text))
        End If

        If PURCHASE3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("PURCHASE3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("PURCHASE3", ToDecimal(PURCHASE3TextBox.Text))
        End If
        If CREDIT_PURCHASE3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_PURCHASE3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_PURCHASE3", ToDecimal(CREDIT_PURCHASE3TextBox.Text))
        End If
        If TERM_PURCHASE3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("TERM_PURCHASE3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("TERM_PURCHASE3", ToDecimal(TERM_PURCHASE3TextBox.Text))
        End If
        If DefaultMargin3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("DEFAULT_MARGIN3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("DEFAULT_MARGIN3", ToDecimal(DefaultMargin3TextBox.Text))
        End If

        If GROSS_PROFIT3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("GROSS_PROFIT3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("GROSS_PROFIT3", ToDecimal(GROSS_PROFIT3TextBox.Text))
        End If




        If CREDIT_LIMIT_BAYTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_LIMIT_BAY", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_LIMIT_BAY", ToDecimal(CREDIT_LIMIT_BAYTextBox.Text))
        End If

        If CREDIT_LIMIT_OTHERTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_LIMIT_OTHER", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_LIMIT_OTHER", ToDecimal(CREDIT_LIMIT_OTHERTextBox.Text))
        End If

        If CREDIT_LIMIT_TCGTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("CREDIT_LIMIT_TCG", 0)
        Else
            sqlCmd.Parameters.AddWithValue("CREDIT_LIMIT_TCG", ToDecimal(CREDIT_LIMIT_TCGTextBox.Text))
        End If


        If BusinessTypeID2TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("BUSINESS_TYPE_ID_2", 0)
        Else
            sqlCmd.Parameters.AddWithValue("BUSINESS_TYPE_ID_2", ToDecimal(BusinessTypeID2TextBox.Text))
        End If

        If BusinessTypeID3TextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("BUSINESS_TYPE_ID_3", 0)
        Else
            sqlCmd.Parameters.AddWithValue("BUSINESS_TYPE_ID_3", ToDecimal(BusinessTypeID3TextBox.Text))
        End If

        If LTVTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("LTV", 0)
        Else
            sqlCmd.Parameters.AddWithValue("LTV", ToDecimal(LTVTextBox.Text))
        End If

        If TCG_LOANTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("TCG_LOAN", 0)
        Else
            sqlCmd.Parameters.AddWithValue("TCG_LOAN", ToDecimal(TCG_LOANTextBox.Text))
        End If

        If TCG_INTEREST_RATE_PERCENT_USEDTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("TCG_INTEREST_RATE_PERCENT_USED", 0)
        Else
            sqlCmd.Parameters.AddWithValue("TCG_INTEREST_RATE_PERCENT_USED", ToDecimal(TCG_INTEREST_RATE_PERCENT_USEDTextBox.Text))
        End If

        If TCG_CONTRACT_YEARTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("TCG_CONTRACT_YEAR", 0)
        Else
            sqlCmd.Parameters.AddWithValue("TCG_CONTRACT_YEAR", ToDecimal(TCG_CONTRACT_YEARTextBox.Text))
        End If

        If TCG_GUARANTEE_OLDTextBox.Text = "" Then
            sqlCmd.Parameters.AddWithValue("TCG_GUARANTEE_OLD", 0)
        Else
            sqlCmd.Parameters.AddWithValue("TCG_GUARANTEE_OLD", ToDecimal(TCG_GUARANTEE_OLDTextBox.Text))
        End If

            sqlCmd.Parameters.AddWithValue("STMT_TYPE", ToDecimal(STMT_TYPEDropDownList.SelectedValue))
