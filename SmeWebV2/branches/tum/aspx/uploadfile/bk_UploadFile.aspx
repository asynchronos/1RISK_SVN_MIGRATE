	...
	<Columns>
	 <asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="File upload">
            ...
            <ItemTemplate>
                <asp:HyperLink ID="linkPath" runat="server"  target='_blank' 
                 text='<%#EVAL("Path") %>' NavigateUrl='<%#  "../../FileUpload/" & EVAL("FILE_YEAR") & "/" & EVAL("FILE_TYPE")  & "/" &  EVAL("PATH") %>'>HyperLink</asp:HyperLink>
            </ItemTemplate>
        </asp:TemplateField>
