<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="CategoryMaster.aspx.vb" Inherits="aspx_category_CategoryMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">

    <script type="text/javascript">
        Ext.ns('Ext.MyExt');
        Ext.MyExt.FormGridXML = Ext.extend(Ext.FormPanel, {
            initComponent: function() {
                formGridXMLId = this.id;
                this.layout = 'column';
                this.items = [
                    this.gridPanelTemplate,
                    this.fieldsetTemplate
                ];

                this.gridPanelTemplate.items.sm = new Ext.grid.RowSelectionModel({
                    singleSelect: true,
                    listeners: {
                        rowselect: function(sm, row, rec) {
                            Ext.getCmp(formGridXMLId).getForm().loadRecord(rec);
                        }
                    }
                });

                this.gridPanelTemplate.items.listeners =
                    {
                ...
                Ext.MyExt.FormGridXML.superclass.initComponent.call(this);


            },
            onRender: function(ct, position) {
                //this.initFormGrid();
                Ext.MyExt.FormGridXML.superclass.onRender.call(this, ct, position);
            }
        });
        ...
        { header: "Rating", width: 40, sortable: true, renderer: rating, dataIndex: 'rating' }
            ...
            var gridForm = new Ext.MyExt.FormGridXML({
                id: 'company-form',
                frame: true,
                labelAlign: 'left',
                title: 'Company data',
