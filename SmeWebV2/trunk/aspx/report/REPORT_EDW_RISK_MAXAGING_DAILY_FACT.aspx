   ...
   &nbsp;&nbsp; <asp:TextBox runat="server" ID="tbcif" MaxLength="20"></asp:TextBox>
    ...
    <asp:FormView ID="FormView1" runat="server" 
      ...
      <table  class="meanning" >
        <tr>
         <td  style=" background-color:#CCCCCC; color: #000000; text-align: left;"  colspan="2"
                     >
          <b>  แสดงความหมาย  Aging History </b>       
         </td>
        </tr>
        <tr>
            <td class="style134" >
     ...
     <b><a href="#" class="showlaw" runat="server" id="showlaw"> แสดงข้อมูลขั้นตอนกฎหมาย</a></b>
      ...
      <td><asp:label class="subject" runat="server" Text="เลขที่คดีดำ : " ID="LabelHC33" />
      ...
      <td><asp:label class="subject" runat="server" Text="เลขที่คดีแดง :"  ID="LabelHC44"  />
     ...
     <td><asp:label class="subject" ID="LabelHChar2" runat="server" Text="ทุนทรัพย์ที่ยื่นฟ้องล้มละลาย :" />
      ...
      <td ><asp:Label class="subject"  ID="LabelHDARA"  runat="server" Text=" วันที่พิพากษาล้มละลาย :" />
    ...
    src="<% response.write("reportPassALSCOM.aspx?cif=" & request("cif")) %>" name="I1">
         ...
         <br />
         <a href='https://www.krungsri-bl-wl.net/' ><b>ข้อมูล blacklist ของลูกค้ารายนี้กรุณาคลิกที่นี่เพื่อเข้าระบบ krungsri Blacklist System</b></a>
