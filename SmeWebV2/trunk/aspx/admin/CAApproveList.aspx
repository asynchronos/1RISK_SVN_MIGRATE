<%@ Page Title="CA Approve List" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="CAApproveList.aspx.vb" Inherits="CAApproveList" EnableEventValidation="false" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<%@ Register src="../../Controls/ExportControl/ExportControl.ascx" tagname="ExportControl" tagprefix="uc1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div id="divApprove">
        ...
        <cc1:CalendarExtender ID="txtBoxApproveDate_CalendarExtender" runat="server"
            TargetControlID="txtBoxApproveDate">
        </cc1:CalendarExtender>
        ถึงวันที่ :
        <asp:TextBox ID="txtBoxApproveDateEnd" runat="server"></asp:TextBox>
        <cc1:CalendarExtender ID="txtBoxApproveDateEnd_CalendarExtender" runat="server" 
            TargetControlID="txtBoxApproveDateEnd">
        </cc1:CalendarExtender>
        <asp:Button ID="btnSearch" runat="server" Text="Search" />
        <uc1:ExportControl ID="ExportControl1" runat="server" 
            ControlName="GridViewCAByApproveDate" AutoGenerateColumns="False" />
    </div>
    <asp:GridView ID="GridViewCAByApproveDate" runat="server" 
        AutoGenerateColumns="False" CellPadding="4" DataSourceID="ODS_CAByApproveDate" 
        ForeColor="#333333" AllowPaging="True" Width="100%" DataKeyNames="OLD_ID" GridLines="Vertical">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="OLD_VALUEs" DataFormatString="{0:#,###.##}" 
                HeaderText="OLD VALUEs" SortExpression="OLD_VALUEs" Visible="False">
            <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField>
            <asp:BoundField DataField="RM_VALUEs" DataFormatString="{0:#,###.##}" 
                HeaderText="RM VALUEs" SortExpression="RM_VALUEs" Visible="False">
            <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField>
            <asp:BoundField DataField="CM_VALUEs" DataFormatString="{0:#,###.##}" 
                HeaderText="CM VALUEs" SortExpression="CM_VALUEs" Visible="False">
            <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField>
            <asp:BoundField DataField="APPROVE_VALUEs" DataFormatString="{0:#,###.##}" 
                HeaderText="APPROVE VALUEs" SortExpression="APPROVE_VALUEs">
            <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField>
            <asp:TemplateField HeaderText="APPROVE DATE" SortExpression="APPROVE_DATE">
                ...
                <ItemTemplate>
                    <asp:Label ID="LabelAPPROVE_DATE" runat="server" 
                        Text='<%# Bind("APPROVE_DATE", "{0:dd/MM/yyyy HH:mm:ss}") %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Wrap="False" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Not Mapping">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButtonCountNullMappingStatus" runat="server"
                        Text='<%# Eval("CountNullMappingStatus") %>'
    ...
    <asp:ObjectDataSource ID="ODS_CAByApproveDate" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="getCreditCAByApproveDate" 
        TypeName="CheckDrawn.business.CheckDrawnBO">
        <SelectParameters>
            <asp:ControlParameter ControlID="txtBoxApproveDate" Name="approveDateNoTimeStart" 
                PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txtBoxApproveDateEnd" 
                Name="approveDateNoTimeEnd" PropertyName="Text" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>

    <asp:Panel id="PanelCLSList" runat="server" Style="display: none" CssClass="modalPopup">
        <iframe id="iframeCLSList" frameborder="0" width="1000px" height="300px" src=""></iframe>
    ...
    <cc1:ModalPopupExtender ID="PanelCLSList_ModalPopupExtender" runat="server" 
        TargetControlID="ButtonReal"
        PopupControlID="PanelCLSList"
        BackgroundCssClass="modalBackground"
        OkControlID="btnOkay"
        CancelControlID="btnCancel"
        OnCancelScript="setBlankIframe()">
