...
SSProject.prototype = {
    ...
    getRATE: function () {
        if (!this.RATE && this.RATE != 0) {
            return this.ShowNotAssignedMsg("RATE");
        } else {
            return this.RATE;
        }
    }
    ...
    , getWORKING_CAPITAL: function () {
        if (!this.WORKING_CAPITAL && this.WORKING_CAPITAL != 0) {
            return this.ShowNotAssignedMsg("WORKING_CAPITAL");
        } else {
   ...
   , I9: function () {
    ...
    , I27: function (useNop) {
        ...
        if (useNop) { // use p'nop function in excel
            ...
            var chkDiv0 = (this.getD35() + this.getD37() + this.getD39()) + (((this.getD31() + this.getD32() + this.getD33()) * this.M27()) / 12);
            if (chkDiv0 == 0) {
                return NaN;
            } else {
                // return ((this.I25() + this.getN25()) / 12) / (chkDiv0);
                return ((this.I25() + this.N25()) / 12) / (chkDiv0);
            }
        }
    }
    , I28: function () {
    ...
    , I31: function () {
        ...
        if (this.getO35() == 0) {
            ...
            if ((this.I25() / this.getO35()) - (this.I30() * this.M27()) > 0) {
                return this.RoundDown(
                     -1 * this.PV(
                        this.M27() / 12
                        , this.getO27() * 12
                        , ((this.I25() / this.getO35()) - (this.I30() * this.M27())) / 12)
                    , -4
                   );
            } else {
                return 0;
        ...
        if (useNop) { // use p'nop function in excel
            if (this.getO35() == 0) {
                ...
                if ((this.I25() / this.getO35() / 12) - (this.getD35() + this.getD37() + this.getD39() - this.getD45()) > 0) {
                    if ((this.I25() / this.getO35() / 12) - (this.I30() * this.M27() / 12) - (this.getD35() + this.getD37() + this.getD39() - this.getD45()) > 0) {
                        return this.RoundDown(this.I30() - (this.N10() + this.N11() - this.getD43()), -4);
                    } else {

                        return this.RoundDown((this.I25() / this.getO35() / 12) - ((this.getD35() + this.getD37() + this.getD39() - this.getD45()) * 12 / this.M27()) - (this.N10() + this.N11() - this.getD43()), -4);
                    }
                } else {
            ...
            if (this.getO35() == 0) {
                ...
                if (temp1 - temp2 > 0) {
                    if (temp1 - (this.I30() * this.M27() / 12) - temp2 > 0) {
                        ...
                        return this.RoundDown(temp1 - (temp2 * 12 / this.M27()) - (this.N10() + this.N11() - this.getD43()), -4);
                    }
                } else {
                    return this.RoundDown(0 - (this.N10() + this.N11() - this.getD43()), -4);
                }
    ...
    , N31: function () {
        if (this.getO35() == 0) {
            ...
            if (((this.getD31() + this.getD32() + this.getD33() - this.getD43()) * this.M27())) {
                d = ((this.getD31() + this.getD32() + this.getD33() - this.getD43()) * this.M27());
            } else {
                d = 0;
            }
            ...
            if ((this.getD35() + this.getD37() + this.getD39() - this.getD45())) {
                f = (this.getD35() + this.getD37() + this.getD39() - this.getD45());
            } else {
                f = 0;
            }
            //var pmt;
            // if (this.PMT(this.getM34() / 12, this.getO34() * 12, this.getI34(), 0)) {
            //            alert('m34' + this.getM34());
            //            alert('o34' + this.getO34());
            //            alert('i34' + this.getI34());
            pmt = this.PMT(this.getM34() / 12, this.getO34() * 12, this.getI34(), 0);

            // ที่กำหนดให้มีตัวแปรแทนแต่ละช่วงเพราะบางช่วงอาจมีค่า 0 หรือ nan ทำให้ค่าไม่ตรง
            return this.RoundDown(
               -1 * this.PV(a, b, ((c - d - e) / 12) - (f + pmt))
            , -4);
        }
    }
    // tam modified 
    ...
    , N43: function () {
        if (this.getO35() == 0) {
            ...
            if ((this.I25() / this.getO35() / 12) - (this.N11() * this.M27() / 12) - (this.getD35() + this.getD37() + this.getD39() - this.getD45()) > 0) {
                if ((this.I25() / this.getO35() / 12) - (this.N11() * this.M27() / 12) - (this.getD35() + this.getD37() + this.getD39() - this.getD45()) - (this.N40() * this.M27() / 12) > 0) {
                    ...
                    if ((((((this.I25() / this.getO35() / 12) - (this.N11() * this.M27() / 12) - (this.getD35() + this.getD37() + this.getD39() - this.getD45())) * 12) / this.M27()) + this.N15() + this.getD41() - this.getI44()) > (this.T17() * this.getO37())) {
                        return this.RoundDown((this.T17() * this.getO37()) - this.N15() - this.getD41() - this.N10(), -4);
                    } else {
    ...
    , R44: function () {
        if (this.getO35() == 0) {
            ...
            //            alert(((this.I25() / this.getO35()) / 12));
            //            alert((((this.N10() + this.N11() - this.getI33()) * this.M27()) / 12));
            //            alert(((this.getI33() * this.getM33()) / 12));
            //            alert(this.getD35() + this.getD37() + this.getD39() - this.getD45());
            //            alert(this.PMT(this.getM34() / 12, this.getO34() * 12, this.getI34(), 0));
            //            var a = ((this.I25() / this.getO35()) / 12);
            //            alert('a=' + a);
            //            var b = (((this.N10() + this.N11() - this.getI33()) * this.M27()) / 12);
            //            alert('b=' + b);
            //            var c = ((this.getI33() * this.getM33()) / 12);
            //            alert('c=' + c);
            //            var d = (this.getD35() + this.getD37() + this.getD39() - this.getD45());
            //            alert('d=' + d);
            //            var e = this.PMT(this.getM34() / 12, this.getO34() * 12, this.getI34(), 0);
            //            alert('e=' + e);
            //            var V = a - b - c  + e;
            //            alert(V);

            if (this.RoundDown(-1 * this.PV(this.M27() / 12, this.getO27() * 12, (this.I25() / this.getO35() / 12) - ((this.N10() + this.N11() - this.getI33()) * this.M27() / 12) - (this.getI33() * this.getM33() / 12) - (this.getD35() + this.getD37() + this.getD39() - this.getD45()) + this.PMT(this.getM34() / 12, this.getO34() * 12, this.getI34())), -4)) {
