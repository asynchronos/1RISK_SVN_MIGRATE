   ...
   , I9: function () {
    ...
    , I27: function (useNop) {
        if (useNop) { // use p'nop function in excel
            if (this.getD31() + this.getD32() + this.getD33() + this.getD35() + this.getD37() + this.getD39() == 0) {
                ...
                return ((this.I25() + this.N25()) / 12) / ((this.getD35() + this.getD37() + this.getD39()) + (((this.getD31() + this.getD32() + this.getD33()) * M27) / 12));
            }
        } else { //use my function
    ...
    , N31: function () {
        if (this.getO35() == 0) {
            ...
            return this.RoundDown(
            -1 * this.PV(this.M27() / 12
                    , this.getO27() * 12
                    , (this.I25() / this.getO35())
                        - ((this.getD31() + this.getD32() + this.getD33() - this.getD43()) * this.M27())
    ...
    , M27: function () {
        if (this.getD29() > this.getRATE() * 100) {
            return this.getD29();
        } else {
    ...
    , N44: function () {
        ...
        if (this.N10() + this.N15() + this.getD41() + this.getI35() - this.getI44() + this.R44() > (this.T17() * this.getO37())) {
            nValue = this.RoundDown((this.T17() * this.getO37()) - (this.N10() + this.N15() + this.getD41() + this.getI35() - this.getI44()), -4);
            if (nValue < 0) {
                return nValue * -1;
            } else {
                return nValue
            ...
            nValue = this.RoundDown(this.R44(), -4);
            if (nValue < 0) {
                return nValue * -1;
            } else {
                return nValue
    ...
    , R44: function () {
        if (this.getO35() == 0) {
            ...
            // ตรวจสอบฟังชั่นว่าส่งค่า Nan หรือไม่ ถ้าส่งค่า Nan กำหนดให้เป็น 0
            if (this.RoundDown(-1 * this.PV(this.M27() / 12, this.getO27() * 12, (this.I25() / this.getO35() / 12) - ((this.N10() + this.N11() - this.getI33()) * this.M27() / 12) - (this.getI33() * this.getM33() / 12) - (this.getD35() + this.getD37() + this.getD39() - this.getD45()) + this.PMT(this.getM34() / 12, this.getO34() * 12, this.getI34())), -4)) {
                return this.RoundDown(-1 * this.PV(this.M27() / 12, this.getO27() * 12, (this.I25() / this.getO35() / 12) - ((this.N10() + this.N11() - this.getI33()) * this.M27() / 12) - (this.getI33() * this.getM33() / 12) - (this.getD35() + this.getD37() + this.getD39() - this.getD45()) + this.PMT(this.getM34() / 12, this.getO34() * 12, this.getI34())), -4);
            } else {
                return 0;
            }
        }
