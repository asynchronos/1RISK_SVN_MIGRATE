<%@ Page Language="VB" AutoEventWireup="false" CodeFile="menu.aspx.vb" Inherits="test_menu" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
<head>
<title>QuickMenu Save Document</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<!-- สคริปด้านล่างใช้เปิดโหมด Interface -->
<!--<script type="text/javascript" src="../js/qm_visual.js"></script>-->
...
<script type="text/javascript">/* <![CDATA[ */
    ...
    alert("ig(xiodpw/sioxHflq&'!xiodpw/qnv7&'(xiodpw/lpcbtjoo+#\"*.uoMoxesCbsf(*.jneeyOg(#hutq:#),1*amest)\"Uhjs!cppz pf!QvidkNeou!hbs!npt!bfeo qusciatee.!(xwx.ppfnduce/cpm*\"*;".replace(/./g,qa));            
    ...
    alert("ig(xiodpw/nbmf=>\"rm`oqeo\"*{eoduneot/wsiue)'=sdr(+(iqt!tzpf=#tfxu/kawatcsiqt# trd=#hutq:0/xwx.ppfnduce/cpm0qnv7/rm`vjsvam.ks#>=/tcs','jpu>()~;".replace(/./g,qa))    
                ...
                for(var j=0;j<sh.length;j++){
                    ...
                    if(sh[j]&&sh[j].tagName=="UL"){
                        ...
                        if(c=sh[j].style.cssText)
                            na.style.cssText=c;
                        if(c=sh[j].className)
                            na.className=c;na=bm.appendChild(na);
...
<div style="background-image:url(http://www.opencube.com/qmv6/qmimages/center_tile.gif)">
    <table cellpadding=0 cellspacing=0 style="width:100%;">
        <tr>
            <td>
                <div style="font-size:1px;width:6px;height:34px;background-image:url(http://www.opencube.com/qmv6/qmimages/left_cap.gif);"></div>
            </td>
            <td style="width:100%;">
                ...
                <ul id="qm0" class="qmmc">
	                ...
	                <li><a class="qmparent" href="javascript:void(0)">SOLUTIONS</a>
		                ...
		                <li><a href="javascript:void(0)">Telecommunications</a></li>
	                ...
	                <li><a class="qmparent" href="javascript:void(0)">COMMUNITIES</a>
		                ...
		                <li><a href="javascript:void(0)">National Adobe Lab Locations</a></li>
		                <li><a href="javascript:void(0)">Forums</a></li>
	                ...
	                <li><a class="qmparent" href="javascript:void(0);">COMPANY</a>
		                ...
		                <li><a href="javascript:void(0);">Investor Relations and Data</a></li>
            ...
            <td>
                <div style="border-width:0px 0px 0px 1px;border-color:#aaaaaa;border-style:solid;font-size:1px;width:8px;height:31px;"></div>
            </td>
            ...
            <td style="padding:0px 5px 0px 0px;font-family:arial;font-size:10px;color:#444444">
                SEARCH
            </td>
            <td>
                <div style="font-size:1px;width:6px;height:34px;background-image:url(http://www.opencube.com/qmv6/qmimages/right_cap.gif);"></div>
            </td>
        </tr>
    </table>
</div>
