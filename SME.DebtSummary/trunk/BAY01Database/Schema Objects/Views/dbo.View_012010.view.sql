...
SELECT     TOP (100) PERCENT TM.REFERENCE, TM.REFERRAL_NO, TM.ID, TM.[REG-DATE], TM.[APP-DATE], TM.CIF, TM.CUSTOMER, TM.[EMP-ID], 
                      ...
                      AS PROCESS_DETAIL
FROM         dbo.TEMP_REPORT_PRODUCT_201001 AS TM INNER JOIN
...
WHERE     (MONTH(TM.[APP-DATE]) = 01) AND (YEAR(TM.[APP-DATE]) = 2010) AND (TM.PROCESS_GROUP IN ('C', 'D', 'E'))
ORDER BY TM.ID
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 45
         ...
         Width = 1500
         Width = 1500
         Width = 1500', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_012010';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'Width = 1500
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_012010';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_012010';
