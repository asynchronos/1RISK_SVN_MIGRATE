CREATE VIEW dbo.V_012_REPORT_S_CANCEL_FOR_BOT
AS
SELECT     R.MONTH, R.CIF, R.CUSTOMER_NAME, R.BUSINESS, SUM(R.RM_VALUEs_OLD_CUS) AS RM_VALUEs_OLD_CUS, SUM(R.RM_VALUEs_NEW_CUS) 
                      ...
                      dbo.REPORT77_02_ALL_SUBJECT_PIVOT_CASHTYPE.RM_VALUEs_NonCash, dbo.REPORT77_02_ALL_SUBJECT_PIVOT_CASHTYPE.RM_VALUEs_NA,
                       R.LAST_PROCESS, R.Reason, R.CIM_NAME, R.CIM_BUSINESS, R.BaySize, R.MIS_SIZE, R.LAST_PROCESS_DATE, R.EMP_ID, R.EMPNAME, 
                      R.LEVEL_ID, R.LEVEL_NAME, R.CA_NO_ID
FROM         dbo.REPORT52_51_CANCEL_FOR_BOT AS R INNER JOIN
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_012_REPORT_S_CANCEL_FOR_BOT';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_012_REPORT_S_CANCEL_FOR_BOT';
