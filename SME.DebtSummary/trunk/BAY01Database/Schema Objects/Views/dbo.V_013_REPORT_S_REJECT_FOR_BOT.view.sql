CREATE VIEW dbo.V_013_REPORT_S_REJECT_FOR_BOT
AS
...
FROM         dbo.REPORT50_49_REJECT_FOR_BOT AS R INNER JOIN
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_013_REPORT_S_REJECT_FOR_BOT';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_013_REPORT_S_REJECT_FOR_BOT';
