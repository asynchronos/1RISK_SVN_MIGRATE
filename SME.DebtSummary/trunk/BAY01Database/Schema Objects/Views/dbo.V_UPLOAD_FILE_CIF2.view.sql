CREATE VIEW dbo.V_UPLOAD_FILE_CIF2
AS
SELECT     TOP (100) PERCENT dbo.V_UPLOADFILE.ID, dbo.V_UPLOADFILE.USER_ID, dbo.V_UPLOADFILE.REMARK, dbo.V_UPLOADFILE.TYPE, 
                      ...
                      dbo.TEMP_REPORT_PRODUCT.Send_To_Board
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[31] 4[14] 2[19] 3) )"
      End
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_UPLOAD_FILE_CIF2';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_UPLOAD_FILE_CIF2';
