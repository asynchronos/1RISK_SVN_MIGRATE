CREATE VIEW dbo.V_017_REPORT_M_APPROVE_FOR_BOT
AS
SELECT     R.MONTH, R.CIF, R.CUSTOMER_NAME, R.BUSINESS, SUM(R.RM_VALUEs_OLD_CUS) AS RM_VALUEs_OLD_CUS, SUM(R.RM_VALUEs_NEW_CUS) 
                      ...
                      R.SIZE_DETAIL, R.LAST_PROCESS_DATE, R.EMP_ID, R.EMPNAME, R.LEVEL_ID, R.LEVEL_NAME, R.CA_NO_ID
FROM         dbo.REPORT74_73_APPROVE_FOR_BOT_M AS R INNER JOIN
...
GROUP BY R.MONTH, R.CIF, R.CUSTOMER_NAME, R.BUSINESS, dbo.REPORT77_02_ALL_SUBJECT_PIVOT_CASHTYPE.RM_VALUEs_Cash, 
                      ...
                      R.BaySize, R.SIZE_DETAIL, R.LAST_PROCESS_DATE, R.EMP_ID, R.EMPNAME, R.LEVEL_ID, R.LEVEL_NAME, R.CA_NO_ID
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_017_REPORT_M_APPROVE_FOR_BOT';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_017_REPORT_M_APPROVE_FOR_BOT';
