CREATE VIEW dbo.REPORT06B_REGIS_PROCESS
AS
SELECT     TOP (100) PERCENT R03.OLD_ID, R03.PROCESS_ID, R03.PROCESS, R03.PROCESS_DATE, R03.PROCESS_GROUP, R03.LEVEL_ID, L.LEVEL_NAME, 
                      R03.EMP_ID
...
dbo.Controlling_Level AS L ON R03.LEVEL_ID = L.LEVEL_ID
WHERE     (R03.SEQ = 1)
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT06B_REGIS_PROCESS';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT06B_REGIS_PROCESS';
