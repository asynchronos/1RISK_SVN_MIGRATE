CREATE VIEW dbo.V_ANNALS_CUS_NCB_CA
AS
SELECT     TOP (100) PERCENT dbo.ANNALS_CUS_NCB.ID, dbo.ANNALS_CUS_NCB.CIF, dbo.CUSTOMER_INFO.Cifname, 
                      ...
                      dbo.V_TEMP_REPORT_PRODUCT_FULL.ID AS Expr1, dbo.V_TEMP_REPORT_PRODUCT_FULL.PROCESS_HEAD, 
                      dbo.V_TEMP_REPORT_PRODUCT_FULL.PROCESS_GROUP, dbo.V_TEMP_REPORT_PRODUCT_FULL.[APP-DATE], 
                      dbo.V_TEMP_REPORT_PRODUCT_FULL.[REG-DATE]
FROM         dbo.ANNALS_CUS_NCB LEFT OUTER JOIN
                      dbo.V_TEMP_REPORT_PRODUCT_FULL ON dbo.ANNALS_CUS_NCB.ID = dbo.V_TEMP_REPORT_PRODUCT_FULL.ID LEFT OUTER JOIN
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[66] 4[7] 2[9] 3) )"
      End
      ...
      Begin Tables = 
         ...
         Begin Table = "V_009_CUSTOMER_NCB_TYPE_11 (CLASSIFY)"
            Begin Extent = 
               Top = 366
               Left = 38
               Bottom =', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_ANNALS_CUS_NCB_CA';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'481
               Right = 227
            End
            DisplayFlags = 280
            TopColumn = 0
         ...
         Begin Table = "V_003_LINKED_CATEGORY_TYPE_1_INFO (CLASSIFY)"
            ...
            TopColumn = 0
         End
         Begin Table = "V_TEMP_REPORT_PRODUCT_FULL"
            Begin Extent = 
               Top = 2
               Left = 501
               Bottom = 218
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_ANNALS_CUS_NCB_CA';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_ANNALS_CUS_NCB_CA';
