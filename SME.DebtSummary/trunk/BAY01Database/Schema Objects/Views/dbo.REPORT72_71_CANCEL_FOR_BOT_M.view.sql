CREATE VIEW dbo.REPORT72_71_CANCEL_FOR_BOT_M
AS
SELECT     TOP (100) PERCENT R.MONTH, R.CIF, ISNULL(R.CUSTOMER_NAME, dbo.GetName(C.CUS_TITLE, C.CUS_FIRST, C.CUS_LAST)) AS CUSTOMER_NAME, 
                      ...
                      R.LEVEL_NAME, R.CA_NO_ID, R.OLD_ID
FROM         dbo.CUSTOMER AS C LEFT OUTER JOIN
                      ...
                      dbo.REPORT71_48_CANCEL_SME_M AS R ON C.CIF = R.CIF
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT72_71_CANCEL_FOR_BOT_M';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT72_71_CANCEL_FOR_BOT_M';
