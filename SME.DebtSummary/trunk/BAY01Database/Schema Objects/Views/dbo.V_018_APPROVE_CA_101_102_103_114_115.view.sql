CREATE VIEW [dbo].[V_018_APPROVE_CA_101_102_103_114_115]
AS
...
WHERE     (R.APPROVE_DATE IS NOT NULL) AND (R.SUBJECT_DETAIL_ID IN (N'101', N'102', N'103', N'114', N'115'))
GROUP BY R.CIF, R.OLD_ID, LTRIM(ISNULL(C.Reason, N'') + N' ' + ISNULL(C.Others, N'')), R.LAST_PROCESS, R.LAST_PROCESS_ID, 
                      ...
                      dbo.EMPLOYEE01.EMPSURNAME), R.APPROVE_DATE, R.SUBJECT_DETAIL_ID
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 38
         ...
         Width = 1500
         Width = 1500
         Width = 15', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_018_APPROVE_CA_101_102_103_114_115';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'00
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_018_APPROVE_CA_101_102_103_114_115';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_018_APPROVE_CA_101_102_103_114_115';
