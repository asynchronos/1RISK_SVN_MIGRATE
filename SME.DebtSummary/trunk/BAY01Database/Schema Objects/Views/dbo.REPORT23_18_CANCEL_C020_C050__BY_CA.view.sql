CREATE VIEW dbo.REPORT23_18_CANCEL_C020_C050__BY_CA
AS
SELECT     OLD_ID, CA_NO_ID, CA_CREATE_DATE, REFERENCE, REFERENCE_DATE, COUNT(DISTINCT CIF) AS CIFs, SUM(OLD_VALUE) AS OLD_VALUEs, 
                      ...
                      Customer_Size, SIZE_DETAIL
FROM         dbo.REPORT18_09_CANCEL_ONLY_C020_C050
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "REPORT18_09_CANCEL_ONLY_C020_C050"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 209
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT23_18_CANCEL_C020_C050__BY_CA';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT23_18_CANCEL_C020_C050__BY_CA';
