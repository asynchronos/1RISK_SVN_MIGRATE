...
FROM         dbo.Temp_Report_Product112009 AS TM INNER JOIN
...
WHERE     (MONTH(TM.[APP-DATE]) = 11) AND (YEAR(TM.[APP-DATE]) = 2009) AND (TM.PROCESS_GROUP IN ('C', 'D', 'E'))
ORDER BY TM.ID
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column =', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_112009';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'1440
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_112009';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_112009';
