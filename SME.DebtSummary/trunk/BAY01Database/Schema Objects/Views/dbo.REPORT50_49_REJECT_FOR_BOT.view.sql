CREATE VIEW dbo.REPORT50_49_REJECT_FOR_BOT
AS
...
FROM         dbo.CUSTOMER AS C LEFT OUTER JOIN
                      ...
                      dbo.REPORT49_47_REJECT_SME_S AS R ON C.CIF = R.CIF
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Table = 1170
         Output = 720
         App', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT50_49_REJECT_FOR_BOT';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'end = 1400
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT50_49_REJECT_FOR_BOT';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'REPORT50_49_REJECT_FOR_BOT';
