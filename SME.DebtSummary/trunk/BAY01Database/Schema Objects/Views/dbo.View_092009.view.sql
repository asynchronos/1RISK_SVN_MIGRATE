...
FROM         dbo.Temp_Report_Product092009 AS TM INNER JOIN
...
WHERE     (MONTH(TM.[APP-DATE]) = 09) AND (YEAR(TM.[APP-DATE]) = 2009) AND (TM.PROCESS_GROUP IN ('C', 'D', 'E'))
ORDER BY TM.ID
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = 1440
         Alias =', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_092009';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'900
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_092009';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_092009';
