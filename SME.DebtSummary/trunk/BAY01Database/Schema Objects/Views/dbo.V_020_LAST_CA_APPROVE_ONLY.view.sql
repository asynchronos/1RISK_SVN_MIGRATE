CREATE VIEW [dbo].[V_020_LAST_CA_APPROVE_ONLY]
AS
...
FROM         [dbo].[V_018_APPROVE_CA]) AS T
WHERE     SEQ = 1
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_020_LAST_CA_APPROVE_ONLY';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V_020_LAST_CA_APPROVE_ONLY';
